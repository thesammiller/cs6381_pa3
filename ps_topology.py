    ...
    def build(self, Racks=1, S=10, P=3):
        ...
        for r in range(Racks):
            ...
            if (r > 0):
                ...
                self.addLink(self.mr_switches[r-1],
                             self.mr_switches[r], delay='5ms')
                print("Added link between",
                      self.mr_switches[r-1], " and ", self.mr_switches[r])
        ...
        print("Added link between ", host, " and switch ",
              self.mr_switches[switch_index])
